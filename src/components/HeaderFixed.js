    ...
    return (
            <header className="HeaderFixed">
                ...
                <div className='HeaderSelectors'>
                    <motion.a initial="hidden" variants={pathVariants} animate="visible" className='HeaderSelector' href='#CompetenciaSection'>-COMPETENCIA-</motion.a>
                    <motion.a initial="hidden" variants={pathVariants} animate="visible" className='HeaderSelector' href='#EquipoSection'>-EQUIPO-</motion.a>
                    <motion.a initial="hidden" variants={pathVariants} animate="visible" className='HeaderSelector'>-MISIONES-</motion.a>
                    <motion.a initial="hidden" variants={pathVariants} animate="visible" className='HeaderSelector'>-SEGUIMIENTO-</motion.a>
                    <motion.a initial="hidden" variants={pathVariants} animate="visible" className='HeaderSelector'>-PROXIMAMENTE-</motion.a>
                </div>
            </header>
    );
  }
